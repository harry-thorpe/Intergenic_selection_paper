...
mkdir "${base_dir}/Analysis/${analysis}/${species}_${analysis}/${species}_core_gene_files";

open OUTPUT, ">${base_dir}/Analysis/${analysis}/${species}_${analysis}/${species}_core_genes.tab";
...
foreach $gene(@gene_array){
	...
	if($isolate_prop >= 0.95){
		move "${base_dir}/Analysis/${analysis}/${species}_${analysis}/${species}_gene_files/$gene.fasta", "${base_dir}/Analysis/${analysis}/${species}_${analysis}/${species}_core_gene_files/$gene.fasta";
