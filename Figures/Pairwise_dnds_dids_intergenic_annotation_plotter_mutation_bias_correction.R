...
file_base_1="/media/harry/extra/Intergenic_variation_paper/Analysis/Pairwise_dnds_dids_intergenic_annotation/"
file_base_2="_Pairwise_dnds_dids_intergenic_annotation/"
file_base_3="_dnds_dids_intergenic_annotation.csv"

file_base_1_1="/media/harry/extra/Intergenic_variation_paper/Analysis/Pairwise_dnds_dids_intergenic_annotation_mutation_bias_correction/"
...
for(i in 1:species_count){
  ...
  file=paste(file_base_1_1, species, file_base_2_2, species, file_base_3_3, sep="")
...
#pdf(file="/media/harry/extra/Intergenic_variation_paper/Figures/Pairwise_dnds_dids_intergenic_annotation_plot.pdf", height=10, width=15)
#tiff(file="/media/harry/extra/Intergenic_variation_paper/Figures/Pairwise_dnds_dids_intergenic_annotation_plot.tif", height=10, width=15, units="in", res=300)
#pdf(file="/media/harry/extra/Intergenic_variation_paper/Figures/Figure_5.pdf", height=10, width=15)
tiff(file="/media/harry/extra/Intergenic_variation_paper/Figures/Figure_5.tif", height=10, width=15, units="in", res=100)
...
file=paste(file_base_1, "M_tuberculosis", file_base_2, "M_tuberculosis", file_base_3, sep="")
...
#pdf(file="/media/harry/extra/Intergenic_variation_paper/Figures/M_tuberculosis_promoter_dIdS_plot.pdf", height=10, width=15)
#tiff(file="/media/harry/extra/Intergenic_variation_paper/Figures/M_tuberculosis_promoter_dIdS_plot.tif", height=10, width=15, units="in", res=300)
#pdf(file="/media/harry/extra/Intergenic_variation_paper/Figures/Figure_S6.pdf", height=10, width=15)
tiff(file="/media/harry/extra/Intergenic_variation_paper/Figures/Figure_S6.tif", height=10, width=15, units="in", res=100)
