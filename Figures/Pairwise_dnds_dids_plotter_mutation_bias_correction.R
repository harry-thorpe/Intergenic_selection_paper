...
file_base_1="/media/harry/extra/Intergenic_variation_paper/Analysis/Pairwise_dnds_dids/"
file_base_2="_Pairwise_dnds_dids/"
file_base_3="_dnds_dids.csv"

file_base_1_1="/media/harry/extra/Intergenic_variation_paper/Analysis/Pairwise_dnds_dids_mutation_bias_correction/"
...
pairwise_dnds_dids_plot <- ggplot(species_dnds_dids_data_long, aes(x=dS, y=dX.dS, colour=Category)) +
  geom_point() +
  coord_cartesian(ylim=c(0, 2)) +
  facet_wrap(~Species, ncol=2, scales="free", labeller=labeller(Species=facet_labels)) +
  scale_colour_discrete(breaks=category_breaks, labels=category_labels) +
  #guides(colour=guide_legend(override.aes=list(alpha=1))) +
  labs(y="dX/dS") +
  theme(strip.text.x=element_text(face="italic"))

#pdf(file="/media/harry/extra/Intergenic_variation_paper/Figures/Pairwise_dnds_dids_plot.pdf", height=10, width=15)
#tiff(file="/media/harry/extra/Intergenic_variation_paper/Figures/Pairwise_dnds_dids_plot.tif", height=10, width=15, units="in", res=300)
#pdf(file="/media/harry/extra/Intergenic_variation_paper/Figures/Figure_S2.pdf", height=10, width=15)
tiff(file="/media/harry/extra/Intergenic_variation_paper/Figures/Figure_S2.tif", height=10, width=15, units="in", res=100)
...
#pdf(file="/media/harry/extra/Intergenic_variation_paper/Figures/Pairwise_dnds_dids_clonal_plot.pdf", height=10, width=15)
#tiff(file="/media/harry/extra/Intergenic_variation_paper/Figures/Pairwise_dnds_dids_clonal_plot.tif", height=10, width=15, units="in", res=300)
#pdf(file="/media/harry/extra/Intergenic_variation_paper/Figures/Figure_3.pdf", height=10, width=15)
tiff(file="/media/harry/extra/Intergenic_variation_paper/Figures/Figure_3.tif", height=10, width=15, units="in", res=100)
